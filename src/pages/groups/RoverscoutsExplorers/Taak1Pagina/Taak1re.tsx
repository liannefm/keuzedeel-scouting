...
function Taak1re() {
    ...
    const [scores, setScores] = useState<string[]>(() => {
        const saved = localStorage.getItem('re-taak1');
        return saved ? JSON.parse(saved) : Array(9).fill('');
    });

    useEffect(() => {
        localStorage.setItem('re-taak1', JSON.stringify(scores));
    }, [scores]);
    ...
    const handleNext = () => {
        ...
        navigate("/roverscouts-explorers/taak-2");
    };
        ...
        <div id="background-explanation">
            <div id="body-explanation">
                ...
                <div className="button-row">
                    ...
                    <button className="nav-button active" id="uitleg-button" onClick={() => navigate("/roverscouts-explorers/taak-1")}>Taak 1</button>
                ...
                <div id="container-explanation">
                    ...
                    <div className="task-group">
                        <div className="task-row">
                            ...
                            <span className="task-text">Periodiek planning taken en werkzaamheden maken (explo) of jongeren hierover adviseren (rover).</span>
                        </div>
                    </div>
                    ...
                    <div className="task-group">
                        ...
                        <div className="task-row">
                            ...
                            <span className="task-text">Bevorderen taakverdeling leidingteam, zowel voor jeugdleden als voor leiding onderling.</span>
                        </div>
                        <div className="task-row">
