...
function Taak3re() {
    ...
    const [scores, setScores] = useState<string[]>(() => {
        const saved = localStorage.getItem('re-taak3');
        return saved ? JSON.parse(saved) : Array(5).fill('');
    });

    useEffect(() => {
        localStorage.setItem('re-taak3', JSON.stringify(scores));
    }, [scores]);
    ...
    const handleNext = () => {
        ...
        navigate("/roverscouts-explorers/score");
    };
                ...
                <div id="container-explanation">
                    ...
                    <div className="task-group">
                        ...
                        <div className="task-row">
                            ...
                            <span className="task-text">Op bekwame wijze speleenheid vertegenwoordigen binnen groep (contacten andere teamleiders, aanspreekpunt ouders/jongeren hierover adviseren).</span>
                        </div>
                        <div className="task-row">
