...
function Taak2re() {
    ...
    const [scores, setScores] = useState<string[]>(() => {
        const saved = localStorage.getItem('re-taak2');
        return saved ? JSON.parse(saved) : Array(14).fill('');
    });

    useEffect(() => {
        localStorage.setItem('re-taak2', JSON.stringify(scores));
    }, [scores]);
    ...
    const handleNext = () => {
        ...
        navigate("/roverscouts-explorers/taak-3");
    };
        ...
        <div id="background-explanation">
            <div id="body-explanation">
                ...
                <div className="button-row">
                    ...
                    <button className="nav-button active" id="uitleg-button" onClick={() => navigate("/roverscouts-explorers/taak-2")}>Taak 2</button>
                ...
                <div id="container-explanation">
                    ...
                    <div className="task-group">
                        ...
                        <div className="task-row">
                            ...
                            <span className="task-text">Bewaken kwalititeit van het activiteitenprogramma samen met jongeren, rekening houdend met de progressiematrix.</span>
                        </div>
                    </div>
                    ...
                    <div className="task-group">
                        <div className="task-row">
                            ...
                            <span className="task-text">Actieve rol aannemen in begeleiding nieuwe teamleden of coaches/adviseurs tijdens introductiefase.</span>
                        </div>
                        <div className="task-row">
                        ...
                        <div className="task-row">
                            ...
                            <span className="task-text">Kwaliteit leidingteam (explo) of speltak (rover) bewaken, in overleg met groeps- en praktijkbegeleider</span>
                        </div>
                        <div className="task-row">
                            <input type="number" className="score-input" min="1" max="5" value={scores[6]} onChange={e => updateScore(6, e.target.value)} />
                            <span className="task-text">Kwaliteit leidingteam (explo) of speltak (rover) verbeteren, in overleg met groeps- en praktijkbegeleider</span>
                        </div>
                        <div className="task-row">
                    ...
                    <div className="task-group">
                        <div className="task-row">
                            ...
                            <span className="task-text">Binnen leidingteam (explo) of de speltak (rover) reflecteren op elkaars houding en gedrag.</span>
                        </div>
                        <div className="task-row">
                            <input type="number" className="score-input" min="1" max="5" value={scores[10]} onChange={e => updateScore(10, e.target.value)} />
                            <span className="task-text">Stimuleren en motiveren explorers, teamleden of roverscouts in houdig en gedrag goed voorbeeld te geven.</span>
                        </div>
                    </div>
                    ...
                    <div className="task-group">
                        <div className="task-row">
                            ...
                            <span className="task-text">Initiatief (regelmatig) teamoverleg en evaluatie explorers en leidingteam (explo) of stambestuur, coaches en medeadviseurs (rovers).</span>
                        </div>
                        <div className="task-row">
